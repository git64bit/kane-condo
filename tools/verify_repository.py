...
REQUIRED_FILES = (
    ...
    Path("render/COUNTY_OVERVIEW_FORMAT.md"),
    Path("render/ROAD_LOD_FORMAT.md"),
    Path("render/WATER_LOD_FORMAT.md"),
    Path("render/BUILDING_LOD_FORMAT.md"),
    Path("render/CLASSIFICATION_SNAPSHOT_FORMAT.md"),
    Path("render/PACKAGE_MANIFEST_FORMAT.md"),
    Path("render/REPRODUCIBLE_PACKAGE_BUILD.md"),
    Path("render/kane-county-overview.sh"),
    Path("render/kane-road-lod.sh"),
    Path("render/kane-water-lod.sh"),
    Path("render/kane-building-lod.sh"),
    Path("render/kane-classification-snapshot.sh"),
    Path("render/kane-package-manifest.sh"),
    Path("render/kane-render-package.sh"),
    Path("render/kane-render-benchmark.sh"),
    Path("render/run-tests.sh"),
    Path("render/tools/kane_county_overview.py"),
    Path("render/tools/kane_road_lod.py"),
    Path("render/tools/kane_water_lod.py"),
    Path("render/tools/kane_building_lod.py"),
    Path("render/tools/kane_classification_snapshot.py"),
    Path("render/tools/kane_package_manifest.py"),
    Path("render/tools/kane_render_package.py"),
    Path("render/tools/kane_render_benchmark.py"),
    Path("render/tests/test_county_overview.py"),
    Path("render/tests/test_road_lod.py"),
    Path("render/tests/test_water_lod.py"),
    Path("render/tests/test_building_lod.py"),
    Path("render/tests/test_classification_snapshot.py"),
...
def verify_shell_entry_points(root: Path) -> int:
    scripts = (
        ...
        root / "render/kane-county-overview.sh",
        root / "render/kane-road-lod.sh",
        root / "render/kane-water-lod.sh",
        root / "render/kane-building-lod.sh",
        root / "render/kane-classification-snapshot.sh",
        root / "render/kane-package-manifest.sh",
