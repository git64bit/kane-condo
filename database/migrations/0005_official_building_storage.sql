-- Kane Condo immutable official building footprints grouped by source release.
CREATE TABLE source_building (
    ...
    CONSTRAINT uk_source_building_release_feature
        UNIQUE (source_release_id, source_feature_id),
    CONSTRAINT uk_source_building_release_ordinal
        UNIQUE (source_release_id, source_ordinal)
);

CREATE INDEX ix_source_building_release
    ON source_building (source_release_id, source_feature_id);
CREATE INDEX ix_source_building_bounds
...
INSERT INTO gpkg_contents (
    ...
    'source_building',
    'features',
    'Kane County official buildings',
